...
- Engineering:
  ...
  - Bump azure-pipelines-task-lib to v4.10.1.
    [#971](https://github.com/microsoft/PSRule-pipelines/pull/971)
  - Bump typescript to v5.4.3.
    [#974](https://github.com/microsoft/PSRule-pipelines/pull/974)
